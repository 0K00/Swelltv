			...
			<div>
				{isTabOne && (
					<React.Fragment>
						...
						>
							<iframe
								src="https://player.twitch.tv/?channel=ahrkaa&parent=localhost"
								parent="localhost"
								height="100%"
								width="100%"
								frameborder="0"
				...
				{isTabTwo && (
					<React.Fragment>
						...
						>
							<iframe
								src="https://player.twitch.tv/?channel=lunath_&parent=localhost"
								parent="localhost"
								height="100%"
								width="100%"
								frameborder="0"
				...
				{isTabThree && (
					<React.Fragment>
						...
						>
							<iframe
								src="https://player.twitch.tv/?channel=inscience_&parent=localhost"
								parent="localhost"
								height="100%"
								width="100%"
								frameborder="0"
